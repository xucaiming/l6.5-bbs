...
Route::prefix('v1')
    ->namespace('Api')
    ->middleware('change-locale')  //语言切换中间件
    ->name('api.v1.')
    ->group(function () {

    Route::middleware('throttle:' . config('api.rate_limits.sign'))->group(function(){  // 频率限制
        ...
        Route::post('socials/{social_type}/authorizations', 'AuthorizationsController@socialStore')
                ->where('social_type', 'weixin') // 如有其它第三方登录模式，则匹配'weixin|qq'
